...
class ServiceOverview extends react_1.Component {
    ...
    async checkForHistoricalData() {
        const result = await apm_1.loadAgentStatus();
    ...
    render() {
        ...
        const noItemsMessage = (react_1.default.createElement(EmptyMessage_1.EmptyMessage, { heading: historicalDataFound
                ...
                : "Looks like you don't have any services with APM installed. Let's add some!", subheading: !historicalDataFound ? react_1.default.createElement(SetupInstructionsLink_1.SetupInstructionsLink, { buttonFill: true }) : null }));
