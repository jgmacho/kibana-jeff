...
const traceListColumns = [
    ...
    },
    {
        ...
        sortable: true,
        dataType: 'number',
        render: (value) => formatters_1.asMillisWithDefault(value)
    },
    {
...
function TraceList({ items = [], noItemsMessage, isLoading }) {
    return isLoading ? null : (react_1.default.createElement(ManagedTable_1.ManagedTable, { columns: traceListColumns, items: items, initialSort: { field: 'impact', direction: 'desc' }, noItemsMessage: noItemsMessage, initialPageSize: 25 }));
}
