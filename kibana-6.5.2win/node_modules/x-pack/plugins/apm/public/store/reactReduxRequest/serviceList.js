...
function ServiceListRequest({ urlParams, render }) {
    ...
    return (react_1.default.createElement(react_redux_request_1.Request, { id: ID, fn: apm_1.loadServiceList, args: [{ start, end, kuery }], selector: getServiceList, render: render }));
}
