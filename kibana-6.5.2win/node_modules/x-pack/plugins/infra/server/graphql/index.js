...
const schema_gql_3 = require("./capabilities/schema.gql");
const schema_gql_4 = require("./log_entries/schema.gql");
...
exports.schemas = [
    ...
    schema_gql_3.capabilitiesSchema,
    schema_gql_4.logEntriesSchema,
