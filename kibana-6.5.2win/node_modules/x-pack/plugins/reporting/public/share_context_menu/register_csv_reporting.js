    ...
    const getShareActions = ({ objectType, objectId, sharingData, isDirty, onClose, }) => {
        ...
        if (xpackInfo.get('features.reporting.csv.showLinks', false)) {
            ...
            shareActions.push({
                ...
                panel: {
                    title: panelTitle,
                    content: (react_1.default.createElement(reporting_panel_content_1.ReportingPanelContent, { reportType: "csv", objectType: objectType, objectId: objectId, getJobParams: getJobParams, isDirty: isDirty, onClose: onClose })),
                },
            });
        }
        return shareActions;
