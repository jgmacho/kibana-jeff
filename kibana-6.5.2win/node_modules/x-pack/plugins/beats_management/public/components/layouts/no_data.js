...
exports.NoDataLayout = react_router_dom_1.withRouter(({ actionSection, title, modalRender, modalClosePath, children, history }) => {
    ...
    return (react_1.default.createElement(eui_1.EuiPage, null,
        react_1.default.createElement(eui_1.EuiPageBody, null,
            react_1.default.createElement(eui_1.EuiFlexGroup, { justifyContent: "spaceAround", style: { marginTop: 50 } },
        ...
        modalContent && (react_1.default.createElement(eui_1.EuiOverlayMask, null,
            react_1.default.createElement(eui_1.EuiModal, { onClose: () => {
                    history.push(modalClosePath);
                }, style: { width: '640px' } }, modalContent)))));
});
