...
function ConnectedLinkComponent({ location, path, query, disabled, ...props }) {
    if (disabled) {
    ...
    return (react_1.default.createElement(react_router_dom_1.Link, Object.assign({}, props, { to: { ...location, ...props.to, pathname, query }, className: `euiLink euiLink--primary ${props.className || ''}` })));
}
