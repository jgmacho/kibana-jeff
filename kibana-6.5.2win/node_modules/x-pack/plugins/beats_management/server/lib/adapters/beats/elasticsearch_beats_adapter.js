...
class ElasticsearchBeatsAdapter {
    ...
    async get(user, id) {
        ...
        return lodash_1.get(response, '_source.beat');
    }
    ...
    async getAllWithTags(user, tagIds) {
        ...
        return beats.map((beat) => lodash_1.omit(beat._source.beat, ['access_token']));
    }
    async getBeatWithToken(user, enrollmentToken) {
        ...
        return lodash_1.omit(lodash_1.get(beats[0], '_source.beat'), ['access_token']);
    }
