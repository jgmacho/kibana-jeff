...
class LoginPage extends react_1.Component {
    constructor() {
        ...
        this.getLoginForm = () => {
            if (this.props.requiresSecureConnection && !this.props.isSecureConnection) {
                return (react_1.default.createElement(disabled_login_form_1.DisabledLoginForm, { title: react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.requiresSecureConnectionTitle", defaultMessage: "A secure connection is required for log in" }), message: react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.requiresSecureConnectionMessage", defaultMessage: "Contact your system administrator." }) }));
            }
            ...
            switch (layout) {
                ...
                case 'error-es-unavailable':
                    return (react_1.default.createElement(disabled_login_form_1.DisabledLoginForm, { title: react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.esUnavailableTitle", defaultMessage: "Cannot connect to the Elastiscearch cluster" }), message: react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.esUnavailableMessage", defaultMessage: "See the Kibana logs for details and try reloading the page." }) }));
                case 'error-xpack-unavailable':
                    return (react_1.default.createElement(disabled_login_form_1.DisabledLoginForm, { title: react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.xpackUnavailableTitle", defaultMessage: "Cannot connect to the Elasticsearch cluster currently configured for Kibana." }), message: react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.xpackUnavailableMessage", defaultMessage: "To use the full set of free features in this distribution of Kibana, please update Elasticsearch to the default distribution." }) }));
                default:
    ...
    render() {
        ...
        return (react_1.default.createElement(react_2.I18nProvider, null,
            react_1.default.createElement("div", { className: "loginWelcome login-form" },
                    ...
                    react_1.default.createElement("div", { className: contentHeaderClasses },
                        ...
                        react_1.default.createElement(eui_1.EuiTitle, { size: "l", className: "loginWelcome__title" },
                            react_1.default.createElement("h1", null,
                                react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.welcomeTitle", defaultMessage: "Welcome to Kibana" }))),
                        react_1.default.createElement(eui_1.EuiText, { size: "s", color: "subdued", className: "loginWelcome__subtitle" },
                            react_1.default.createElement("p", null,
                                react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.login.welcomeDescription", defaultMessage: "Your window into the Elastic Stack" }))),
