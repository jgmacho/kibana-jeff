...
class SimplePrivilegeForm extends react_1.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        const description = react_1.default.createElement("p", null, "Specifies the Kibana privilege for this role.");
        return (react_1.default.createElement(react_1.Fragment, null,
            react_1.default.createElement(eui_1.EuiDescribedFormGroup, { title: react_1.default.createElement("h3", null, "Kibana privileges"), description: description },
                react_1.default.createElement(eui_1.EuiFormRow, { hasEmptyLabelSpace: true },
                    react_1.default.createElement(privilege_selector_1.PrivilegeSelector, { "data-test-subj": 'kibanaPrivilege', availablePrivileges: kibanaAppPrivileges, value: kibanaPrivilege, disabled: role_1.isReservedRole(role), allowNone: true, onChange: this.onKibanaPrivilegeChange })))));
    }
}
