...
/******/ 	return __webpack_require__(__webpack_require__.s = 1865);
/******/ })
/************************************************************************/
/******/ ({
...
var _index = __webpack_require__(1866);

_index.transformSpecs.forEach(canvas.register); /*
...
exports.transformSpecs = undefined;

var _sort = __webpack_require__(1867);

var transformSpecs = exports.transformSpecs = [_sort.sort]; /*
                                                             * Copyright Elasticsearch B.V. and/or licensed to Elasticsearch B.V. under one
                                                             * or more contributor license agreements. Licensed under the Elastic License;
                                                             * you may not use this file except in compliance with the Elastic License.
                                                             */
...
var sort = exports.sort = function sort() {
  return {
    ...
    resolve: function resolve(_ref) {
      ...
      if ((0, _resolved_arg.getState)(context) === 'ready') return { columns: (0, _lodash.get)((0, _resolved_arg.getValue)(context), 'columns', []) };
