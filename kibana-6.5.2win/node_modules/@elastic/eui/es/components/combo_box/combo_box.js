...
function (_Component) {
  ...
  function EuiComboBox(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addCustomOption", function () {
      if (_this.doesSearchMatchOnlyOption()) {
        _this.onAddOption(_this.state.matchingOptions[0]);

        return;
      }

      if (!_this.props.onCreateOption) {
        return;
      } // Don't create the value if it's already been selected.


      if (getSelectedOptionForSearchValue(_this.state.searchValue, _this.props.selectedOptions)) {
        return;
      } // Add new custom pill if this is custom input, even if it partially matches an option..


      var isOptionCreated = _this.props.onCreateOption(_this.state.searchValue, flattenOptionGroups(_this.props.options)); // Expect the consumer to be explicit in rejecting a custom option.
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "areAllOptionsSelected", function () {
      var _this$props = _this.props,
          ...
          async = _this$props.async; // Assume if this is async then there could be infinite options.
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onBlur", function (e) {
      ...
      var focusedInOptionsList = _this.optionsList && _this.optionsList.contains(e.relatedTarget);

      var focusedInInput = _this.comboBox && _this.comboBox.contains(e.relatedTarget);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onComboBoxLoseFocus", function (e) {
      if (!_this.comboBox || !_this.comboBox.contains(e.relatedTarget)) {
        _this.closeList();
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onComboBoxClick", function () {
      ...
      _this.searchInput.focus(); // If the user does this from a state in which an option has focus, then we need to clear it.
    ...
    _this.state = {
      matchingOptions: getMatchingOptions(_options, _selectedOptions, initialSearchValue, props.async),
  ...
  _createClass(EuiComboBox, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          onCreateOption = _this$props5.onCreateOption,
          placeholder = _this$props5.placeholder,
          noSuggestions = _this$props5.noSuggestions,
          renderOption = _this$props5.renderOption,
          singleSelection = _this$props5.singleSelection,
          onChange = _this$props5.onChange,
          onSearchChange = _this$props5.onSearchChange,
          async = _this$props5.async,
          ...
          rest = _objectWithoutProperties(_this$props5, ["id", "isDisabled", "className", "isLoading", "options", "selectedOptions", "onCreateOption", "placeholder", "noSuggestions", "renderOption", "singleSelection", "onChange", "onSearchChange", "async", "isInvalid", "rowHeight", "isClearable", "fullWidth", "compressed", "data-test-subj"]);

      var _this$state = this.state,
          searchValue = _this$state.searchValue,
          isListOpen = _this$state.isListOpen,
          listPosition = _this$state.listPosition,
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var searchValue = prevState.searchValue; // Calculate and cache the options which match the searchValue, because we use this information
      // in multiple places and it would be expensive to calculate repeatedly.

      var matchingOptions = getMatchingOptions(options, selectedOptions, searchValue, nextProps.async);
      return {
