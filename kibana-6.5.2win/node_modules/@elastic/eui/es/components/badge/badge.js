...
export var EuiBadge = function EuiBadge(_ref) {
  ...
  if (COLORS.indexOf(color) > -1) {
    ...
    if (isColorDark.apply(void 0, _toConsumableArray(hexToRgb(color)))) {
      textColor = '#FFFFFF';
    } else {
      textColor = '#000000';
    }
  ...
  var classes = classNames('euiBadge', iconSideToClassNameMap[iconSide], optionalColorClass, className);
  var optionalIcon = null;

  if (iconType) {
    if (iconOnClick) {
      optionalIcon = React.createElement(EuiKeyboardAccessible, null, React.createElement(EuiIcon, _extends({
        onClick: iconOnClick,
        type: iconType,
        size: "s",
      ...
      optionalIcon = React.createElement(EuiIcon, {
        type: iconType,
        size: "s",
        className: "euiBadge__icon"
      });
  ...
  if (onClick) {
    ...
    }, optionalIcon, React.createElement("span", null, children)));
  } else {
...
EuiBadge.propTypes = {
   ...
   */
  iconOnClick: EuiPropTypes.withRequiredProp(PropTypes.func, 'iconOnClickAriaLabel', 'Please provide an aria label to complement your iconOnClick'),
   ...
   */
  onClick: EuiPropTypes.withRequiredProp(PropTypes.func, 'onClickAriaLabel', 'Please provide an aria label to complement your onClick'),
