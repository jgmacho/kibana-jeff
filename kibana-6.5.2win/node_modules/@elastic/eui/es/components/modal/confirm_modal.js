  ...
  _createClass(EuiConfirmModal, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["children", "title", "onCancel", "onConfirm", "cancelButtonText", "confirmButtonText", "className", "buttonColor", "defaultFocusedButton"]);
      ...
      return React.createElement(EuiModal, _extends({
        className: classes,
        onClose: onCancel
      }, rest), modalTitle, React.createElement(EuiModalBody, null, React.createElement(EuiText, {
