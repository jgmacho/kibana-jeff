...
function (_Component) {
  ...
  function EuiCodeEditor() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "idGenerator", htmlIdGenerator());
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "aceEditorRef", function (aceEditor) {
      if (aceEditor) {
        ...
        aceEditor.editor.textInput.getElement().addEventListener('keydown', _this.onKeydownAce);
      }
    });
  ...
  _createClass(EuiCodeEditor, [{
    ...
    value: function render() {
      ...
      var activity = isReadOnly ? 'interacting with the code' : 'editing'; // Don't use EuiKeyboardAccessible here because it doesn't play nicely with onKeyDown.
      ...
      var prompt = React.createElement("div", {
        ...
        className: "euiText"
      }, "Press Enter to start ", activity, "."), React.createElement("p", {
        className: "euiText"
      ...
      }, prompt, React.createElement(AceEditor, _extends({
