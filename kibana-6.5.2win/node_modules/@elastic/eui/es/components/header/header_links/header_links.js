...
function (_Component) {
  ...
  function EuiHeaderLinks(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(EuiHeaderLinks).call(this, props));
  ...
  _createClass(EuiHeaderLinks, [{
    ...
    value: function render() {
      ...
      var button = React.createElement(EuiHeaderSectionItem, {
        border: "left"
      }, React.createElement(EuiHeaderSectionItemButton, {
      ...
      return React.createElement("nav", _extends({
        ...
        role: "navigation"
      }, children), React.createElement(EuiPopover, {
