...
function (_Component) {
  ...
  function EuiRange(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderTicks", function (tickObject) {
      ...
      return React.createElement("div", {
        ...
        var tickClasses = classNames('euiRange__tick', {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderValue", function () {
      ...
      var valueClasses = classNames('euiRange__value', "euiRange__value--".concat(valuePositionSide));
      return React.createElement("div", {
  ...
  _createClass(EuiRange, [{
    ...
    value: function render() {
      ...
      var wrapperClasses = classNames('euiRange__wrapper', {
      ...
      if (showInput) {
        ...
        var maxWidthStyle = {
          maxWidth: "".concat(String(max).length + 2, "em")
        }; // Make this input the main control by disabling screen reader access to slider control

        sliderTabIndex = '-1';
        extraInputNode = React.createElement(EuiFieldNumber, _extends({
          name: name,
      ...
      }, this.renderLabel('min'), React.createElement("div", {
...
function calculateTicksObject(min, max, interval) {
  ...
  var sequence = range(min, max + toBeInclusive, interval);
  return {
