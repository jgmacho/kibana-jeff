  ...
  function EuiSuperSelect(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "openPopover", function () {
      ...
      var focusSelected = function focusSelected() {
        ...
        }, null); // valueOfSelected is optional, and options may not exist yet
  ...
  _createClass(EuiSuperSelect, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["className", "options", "valueOfSelected", "onChange", "isOpen", "hasDividers", "itemClassName", "itemLayoutAlign"]);
      ...
      return React.createElement(EuiPopover, {
        ...
        role: "alert"
      }, "You are in a form selector of ", options.length, " items and must select a single option. Use the up and down keys to navigate or escape to close.")), React.createElement("div", {
        role: "listbox",
