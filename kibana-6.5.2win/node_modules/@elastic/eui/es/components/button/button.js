...
export var EuiButton = function EuiButton(_ref) {
  ...
  var classes = classNames('euiButton', colorToClassNameMap[color], sizeToClassNameMap[size], iconSideToClassNameMap[iconSide], className, {
    'euiButton--fill': fill
  ...
  if (href && !isDisabled) {
    var secureRel = getSecureRelForTarget(target, rel);
