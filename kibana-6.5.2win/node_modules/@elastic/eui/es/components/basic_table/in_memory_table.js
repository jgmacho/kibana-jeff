...
import { EuiBasicTable, SelectionType, ItemIdType, FieldDataColumnTypeShape, ComputedColumnType, ActionsColumnType } from './basic_table';
...
import { QueryType, SearchFiltersFiltersType, SearchBoxConfigPropTypes, EuiSearchBar } from '../search_bar';
import { EuiSpacer } from '../spacer/spacer'; // same as ColumnType from EuiBasicTable, but need to modify the `sortable` type

var ColumnType = PropTypes.oneOfType([PropTypes.shape(_objectSpread({}, FieldDataColumnTypeShape, {
  sortable: PropTypes.oneOfType([PropTypes.bool, PropTypes.func])
})), ComputedColumnType, ActionsColumnType]);
var InMemoryTablePropTypes = {
  ...
  search: PropTypes.oneOfType([PropTypes.bool, PropTypes.shape({
    ...
    box: PropTypes.shape(_objectSpread({}, SearchBoxConfigPropTypes, {
      schema: PropTypes.oneOfType([// here we enable the user to just assign 'true' to the schema, in which case
      // we will auto-generate it out of the columns configuration
      PropTypes.bool, SearchBoxConfigPropTypes.schema])
    })),
...
var getInitialPagination = function getInitialPagination(pagination) {
  ...
  var initialPageSize = pagination.initialPageSize,
      ...
      pageSizeOptions = _pagination$pageSizeO === void 0 ? paginationBarDefaults.pageSizeOptions : _pagination$pageSizeO,
...
function (_Component) {
  ...
  _createClass(EuiInMemoryTable, [{
    ...
    value: function renderSearchBar() {
      ...
      if (search) {
        var _ref3 = isBoolean(search) ? {} : search,
    ...
    value: function getItems() {
      ...
      var matchingItems = query ? EuiSearchBar.Query.execute(query, items) : items;
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["columns", "loading", "message", "error", "selection", "isSelectable", "hasActions", "compressed", "pagination", "sorting", "itemIdToExpandedRowMap", "itemId", "rowProps", "cellProps", "items", "search", "onTableChange"]);
      ...
      var table = React.createElement(EuiBasicTable, _extends({
        items: items,
        itemId: itemId,
        rowProps: rowProps,
        cellProps: cellProps,
