...
function findPopoverPosition(_ref) {
  var anchor = _ref.anchor,
      ...
      buffer = _ref$buffer === undefined ? 16 : _ref$buffer,
      _ref$offset = _ref.offset,
      offset = _ref$offset === undefined ? 0 : _ref$offset,
      _ref$allowCrossAxis = _ref.allowCrossAxis,
      allowCrossAxis = _ref$allowCrossAxis === undefined ? true : _ref$allowCrossAxis,
      container = _ref.container,
      arrowConfig = _ref.arrowConfig;

  container = (0, _reactDom.findDOMNode)(container); // resolve any React abstractions
  ...
  var iterationPositions = [position]; // Try the user-desired position first.
  var iterationAlignments = [align]; // keep user-defined alignment in the original positions.
  ...
  var _iterationPositions$r = iterationPositions.reduce(function (_ref2, iterationPosition, idx) {
    var bestFit = _ref2.bestFit,
        bestPosition = _ref2.bestPosition;

    // If we've already found the ideal fit, use that position.
    if (bestFit === 1) {
      return { bestFit: bestFit, bestPosition: bestPosition };
    }
    ...
    bestPosition: null
      ...
      bestPosition = _iterationPositions$r.bestPosition;
 ...
 */
function getPopoverScreenCoordinates(_ref3) {
  var _popoverPlacement, _ref4;

  var position = _ref3.position,
      align = _ref3.align,
      anchorBoundingBox = _ref3.anchorBoundingBox,
      popoverBoundingBox = _ref3.popoverBoundingBox,
      windowBoundingBox = _ref3.windowBoundingBox,
      containerBoundingBox = _ref3.containerBoundingBox,
      arrowConfig = _ref3.arrowConfig,
      _ref3$offset = _ref3.offset,
      offset = _ref3$offset === undefined ? 0 : _ref3$offset,
      _ref3$buffer = _ref3.buffer,
      buffer = _ref3$buffer === undefined ? 0 : _ref3$buffer;
  ...
  var arrow = arrowConfig ? (_ref4 = {}, _defineProperty(_ref4, crossAxisFirstSide, crossAxisArrowPosition - popoverPlacement[crossAxisFirstSide]), _defineProperty(_ref4, primaryAxisPositionName, primaryAxisArrowPosition), _ref4) : undefined;
...
function getCrossAxisPosition(_ref5) {
  var crossAxisFirstSide = _ref5.crossAxisFirstSide,
      crossAxisSecondSide = _ref5.crossAxisSecondSide,
      crossAxisDimension = _ref5.crossAxisDimension,
      position = _ref5.position,
      align = _ref5.align,
      buffer = _ref5.buffer,
      offset = _ref5.offset,
      windowBoundingBox = _ref5.windowBoundingBox,
      containerBoundingBox = _ref5.containerBoundingBox,
  ...
  var crossAxisArrowPosition = void 0;
  if (arrowConfig) {
    var arrowWidth = arrowConfig.arrowWidth;

    var _anchorSizeOnCrossAxis = anchorBoundingBox[crossAxisDimension];
    var _anchorHalfSize = _anchorSizeOnCrossAxis / 2;
    crossAxisArrowPosition = anchorBoundingBox[crossAxisFirstSide] + _anchorHalfSize - arrowWidth / 2;
...
function getPrimaryAxisPosition(_ref6) {
  var position = _ref6.position,
      offset = _ref6.offset,
      popoverBoundingBox = _ref6.popoverBoundingBox,
      anchorBoundingBox = _ref6.anchorBoundingBox,
      arrowConfig = _ref6.arrowConfig;
  ...
  var primaryAxisArrowPosition = void 0;
...
function getElementBoundingBox(element) {
  element = (0, _reactDom.findDOMNode)(element); // resolve any React abstractions
...
function getElementZIndex(element, cousin) {
  ...
  cousin = (0, _reactDom.findDOMNode)(cousin);
  ...
  return nodesToInspect.reduce(function (foundZIndex, node) {
