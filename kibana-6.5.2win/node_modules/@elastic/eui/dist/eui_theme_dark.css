...
.euiComboBoxOptionsList {
  ...
  .euiComboBoxOptionsList.euiComboBoxOptionsList--top {
    /* 4 */
    -webkit-box-shadow: 0 -2px 4px -1px rgba(0, 0, 0, 0.2), 0 0px 2px 0 rgba(0, 0, 0, 0.2);
            box-shadow: 0 -2px 4px -1px rgba(0, 0, 0, 0.2), 0 0px 2px 0 rgba(0, 0, 0, 0.2); }
...
.euiTableRow-isClickable:hover {
  background-color: rgba(77, 161, 192, 0.05);
  cursor: pointer; }
